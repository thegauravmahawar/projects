...
public class OrderEvent extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -5046577374329683956L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"OrderEvent\",\"namespace\":\"shoppingapplicationbackend.order.service.models\",\"fields\":[{\"name\":\"orderNumber\",\"type\":\"string\"}]}");
   ...
   */
  public OrderEvent(java.lang.CharSequence orderNumber) {
   ...
   */
  public static shoppingapplicationbackend.order.service.models.OrderEvent.Builder newBuilder() {
    return new shoppingapplicationbackend.order.service.models.OrderEvent.Builder();
  }
   ...
   * @return A new OrderEvent RecordBuilder
   */
  public static shoppingapplicationbackend.order.service.models.OrderEvent.Builder newBuilder(shoppingapplicationbackend.order.service.models.OrderEvent.Builder other) {
    if (other == null) {
      return new shoppingapplicationbackend.order.service.models.OrderEvent.Builder();
    } else {
      return new shoppingapplicationbackend.order.service.models.OrderEvent.Builder(other);
    }
  }
   ...
   * @return A new OrderEvent RecordBuilder
   */
  public static shoppingapplicationbackend.order.service.models.OrderEvent.Builder newBuilder(shoppingapplicationbackend.order.service.models.OrderEvent other) {
    if (other == null) {
      return new shoppingapplicationbackend.order.service.models.OrderEvent.Builder();
    } else {
      return new shoppingapplicationbackend.order.service.models.OrderEvent.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<OrderEvent>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(shoppingapplicationbackend.order.service.models.OrderEvent.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(shoppingapplicationbackend.order.service.models.OrderEvent other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.orderNumber)) {
        this.orderNumber = data().deepCopy(fields()[0].schema(), other.orderNumber);
    ...
    /**
      ...
      * @return This builder.
      */
    public shoppingapplicationbackend.order.service.models.OrderEvent.Builder setOrderNumber(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public shoppingapplicationbackend.order.service.models.OrderEvent.Builder clearOrderNumber() {
      orderNumber = null;
